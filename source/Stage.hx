...
class Stage
{
    ...
    public var slowBacks:Map<Int, Array<FlxSprite>> = []; // C/ Change/add/remove backgrounds mid song! Format: "slowBacks[StepToBeActivated] = [Sprites,To,Be,Change//first [0] - in front of GF, second [1] - in front of bf, third [2] - in front of opponent(and techincally also BF since Haxe layering moment)
